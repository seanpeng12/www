...
<body>
	...
	<div class="modal fade bg-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	 aria-hidden="true">
					...
					<form action="#">
						...
						<div class="form-group">
							...
							<select style="color: black" class="form-control" id="sel1">
								<option value="" disabled selected hidden>請選擇一個指導老師</option>
								<option>李俊民</option>
								<option>陳子立</option>
								<option>蔡明志</option>
								<option>廖建翔</option>
		...
		<div class="contact">
			<div class="container">
				<div class="row">
					...
					<!-- Contact Info -->
					<div class="col-lg-5 offset-xl-1 contact_col">
						<div class="contact_info">
							<div class="contact_info_section">
								<div class="contact_info_title">評分方式</div>
								<ul>
									<li>專題學期分數由專題指導老師評訂。</li>
									<li>▪<span>文件審查階段</span>－評審老師提出改進建議。</li>
									<li>▪<span>系統驗收階段</span>－評分項目包括：系統文件、系統功能，佔專題發表分數比重之<span style="font-size: 18px;font-weight: bold">60%</span>。</li>
									<li>▪<span>正式發表階段</span>－評分項目包括：專題發表臨場表現及系統驗收後整體系統功能修改程度，佔專題發表分數比重之<span>40%</span>。</li>


									<li>評分細項請參照專題發表評分標準說明。</li>
								</ul>
							</div>
							<div class="contact_info_section">
								<div class="contact_info_title">備註</div>
								<ul>
									<li>▪每組以5人為限，建議儘可能填滿指導老師志願序。</li>
									<li>▪08/27（一）16:30以前回傳選組志願表，逾期不受理，已繳交者不得重新修改。</li>
									<li>▪未填寫志願表者，則以剩下之名額遞補。</li>
									<li>▪尚未有組別落單者，請個別回覆班級、姓名、EMAIL，並請當天務必親自到場，由系上協助媒合。</li>
									<li>▪分組抽籤時間定於09/ 10（一）中午13：00-13：30，地點：LM302（暫定），請各組推派代表參加。</li>
								</ul>
								<p>
									助教&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;啟 2018/11/8
								</p>
