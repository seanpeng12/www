			...
			<form action="Sign_in.php">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p>
							歡迎使用輔仁大學資訊管理學系（以下稱本單位）所提供之資訊專題管理系統(http://project.im.fju.edu.tw)，依據個人資料保護法（以下稱個資法）第八條第一項規定，為了確保使用者之個人資料、隱私及權益之保護，當您已閱讀並同意「輔仁大學資訊管理學系個人資料保護法告知內容」時，即表示您願意以電子文件之方式行使法律所賦予同意之權利，並具有書面同意之效果，若不同意請離開此網頁，如需服務請洽本單位之服務人員。
							(以下為本單位依「個人資料保護法」規定，必須向您告知的各項聲明，請您務必詳閱。)</li>
						</p>
						<ul>1. 個人資料蒐集目的：
							<li>（一）依照輔仁大學資訊管理學系所舉辦之資訊專題課程期間之行為均屬於本系統之個資蒐集目的。</li>
							<li>（二）上述之相關業務所定義之工作範圍。</li>

						</ul>
						<li>
							<ul>2. 個人資料蒐集來源：
								<li>（一）輔仁大學學校財團法人所提供LDAP相關服務之電磁紀錄
								<li>（二）您於註冊程序時所填寫之個人聯絡資料
							</ul>
							<ul>
								3. 個人資料蒐集類別：
								<li>（一）識別類（例如：中文姓名、學生或員工證號、聯絡電話號碼、地址、性別、電子郵遞地址）
								<li>（二）特徵類（例如：出生年月日、國籍、個人照片、筆跡與紙本文件）等。
							</ul>
							<ul>
								4. 個人資料利用之期間、地區、對象及方式：
								<li>（一）期間：利用期間為本單位或業務所必須之保存期間。
								<li>（二）地區：您的個人資料將用於本單位提供服務之地區。
								<li>（三）對象：本單位經手資訊專題課程之相關行政人員、依法有調查權機關。
								<li>（四）方式：電子文件、紙本，或以自動化機器或其他非自動化之利用方式。
							</ul>
							<ul>
								5. 依據個資法第三條規定，您就本單位保有您的個人資料得行使下列權利：
								<li>（一）查詢、閱覽、複本、補充、更正、請求停止蒐集、請求停止處理、請求停止利用、請求刪除等權利。
							</ul>
							<ul>
								6. 個資保護之措施：
									...
									<ul>
										...
										<li>
											...
											<div class="container">
												...
												<button type="button" class="btn btn-light" data-toggle="modal" data-target="#myModal">註冊</button>
