					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="#">修改個人資料</a></div>
								<nav class="main_nav">
									<ul>
								...
								<div class="home_content">
									<div class="breadcrumbs">
										<ul>
											...
											<li><a href="contact.php">歡迎頁面</a></li>
											<li><a href="Sign_in.php">驗證LDAP</a></li>
											<li>修改個人資料</li>
										</ul>
									</div>
								</div>
						...
						<div class="get_in_touch">
							...
							<form action="contact.php" id="contact_form" class="contact_form" method="POST">
								...
								<div class="contact_form_container">
									...
									<div class="row">
										<div class></div>
										<div class="special_contact col-lg-2">
											<label for="contact_company">學號</label>
											<p>407402513</p>
										</div>
										<div class="special_contact col-lg-1">
											<label for="contact_company">性別</label>
											<p>男</p>
										</div>
										<div class="special_contact col-lg-9">
											<label for="contact_company">姓名</label>
											<p>陳金三</p>
										</div>
									</div>
									<div class="row">
										<div class="special_contact col-lg-2">
											<label for="contact_company">所屬學院</label>
											<p>管理學院</p>
										</div>

										<div class="special_contact col-lg-3">
											<label for="contact_company">系級</label>
											<p>資管二甲</p>
										</div>
									</div>

									<div>
										<label for="contact_name">電話</label>
										<input type="text" id="contact_name" class="contact_input" placeholder="0905000000">
									</div>
									<div>

										<label for="contact_company">聯絡信箱</label>
										<input type="text" id="contact_company" class="contact_input" placeholder="a12345@example.com">
									</div>



									<button class="button contact_button" type="submit" onclick=" myFunction()"><span>送出</span></button>

									<script>
										function myFunction() {
											alert("您已成功註冊，按確定導向登入頁面");
											contact_form.submit();
										}
									</script>
